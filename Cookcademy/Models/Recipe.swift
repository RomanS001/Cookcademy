  ...
  static let testRecipes: [Recipe] = [
    Recipe(
      mainInformation: MainInformation(
        ...
        category: .dinner),
      ingredients: [
        Ingredient(name: "Potatoes", quantity: 454, unit: .grams),
    ...
    Recipe(
      mainInformation: MainInformation(
        ...
        category: .dinner),
      ingredients: [
        Ingredient(name: "Brisket", quantity: 1815, unit: .grams),
        ...
        Ingredient(name: "Chicken Stock", quantity: 30, unit: .ounces)
      ],
      // swiftlint:disable all
      directions: [
    ...
    Recipe(
      ...
      category: .dessert),
      ingredients: [
        Ingredient(name: "Condensed Milk", quantity: 14, unit: .ounces),
        Ingredient(name: "Crushed Graham Crackers", quantity: 2.5, unit: .cups),
        Ingredient(name: "Bag of Chocolate Chips (Semi-Sweet)", quantity: 12, unit: .ounces),
    ...
    Recipe(
      ...
      ingredients: [
        ...
        Ingredient(name: "Parmesan, finely grated", quantity: 1, unit: .ounces),
        Ingredient(name: "Fresh Lemon Juice", quantity: 2, unit: .tbs),
        Ingredient(name: "Baby Spinach", quantity: 3, unit: .ounces)
      ],
      directions: [
    ...
    Recipe(
      ...
      ingredients: [
        Ingredient(name: "Kosher Salt", quantity: 1, unit: .none),
        Ingredient(name: "Linguine", quantity: 12, unit: .ounces),
        Ingredient(name: "Large shrimp, peeled", quantity: 20, unit: .ounces),
    ...
    Recipe(
      mainInformation: MainInformation(
        name: "Chocolate Billionaires",
        description: "Chocolate and caramel candies that are to die for!",
        author: "Jack B",
        category: .dessert),
      ingredients: [
        Ingredient(name: "1 package of caramels", quantity: 14, unit: .ounces),
    ...
    Recipe(
      mainInformation: MainInformation(
        ...
        category: .dinner),
      ingredients: [
        Ingredient(name: "Elbow Macaroni", quantity: 12, unit: .ounces),
